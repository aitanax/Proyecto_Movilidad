# Practica Modelado 2
#
# Este código busca la solución óptima para minimizar el Costo Total
...
# 6:
    ...
    s.t. distri_llama {parking in PARKINGS, distrito in DISTRITOS}: decision[parking, distrito] <= (0.75 * max_llamadas_parking) - 1;
